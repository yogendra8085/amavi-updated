class FilterListModel {
  ...
  FilterListModel.fromJson(Map<String, dynamic> json) {
    ...
    productTotal = int.parse(json['product_total'].toString());
    stock = json['stock'];
    if (json['sorts'] != null) {
      sorts = <Sorts>[];
...
class AllCategories {
  ...
  AllCategories({this.categoryId, this.name, this.children, this.isExpanded});
...
class Children {
  ...
  Children({this.name, this.categoryId, this.categoryStatus, this.isChecked});
